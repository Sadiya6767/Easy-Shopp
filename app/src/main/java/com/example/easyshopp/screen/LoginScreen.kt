...
fun LoginScreen(modifier: Modifier = Modifier, navController: NavController, authViewModel: AuthViewModel= viewModel()){
    ...
    Column(modifier = modifier.fillMaxSize()
        ...
        Image(painter = painterResource(id = R.drawable.signup_img),
        ...
        Button(onClick ={
            ...
            Text(text = if(isLoading) "Logging in" else "SignUp", fontSize = 22.sp)
        }
        ...
        TextButton(onClick = {
            ...
            Text(text = "Create Your Account? Sign Up")
        }
